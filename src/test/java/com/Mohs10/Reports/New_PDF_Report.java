...
public class New_PDF_Report extends StartBrowser {
    ...
    public void PDFreports(ITestContext context) throws IOException {
        ...
        for (int m = 1; m <= 3; m++) {
            //String htmlpath = "test-output\\Suite\\TestNG_Report" + m + ".html"; //original
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/table/tbody/tr[1]/td[2]")));
